...
##########################################################################
class MPRNetPassFeature(nn.Module):
    ...
    def forward(self, x3_img,feat1_ltop, feat1_rtop,feat1_lbot):
        ...
        if feat1_ltop is None:
            x1ltop = self.shallow_feat1(x1ltop_img)
        if feat1_rtop is None:
            x1rtop = self.shallow_feat1(x1rtop_img)
        if feat1_lbot is None:
        ...
        return [stage3_img+x3_img, stage2_img, stage1_img,feat1_rtop,feat1_lbot,feat1_rbot]
